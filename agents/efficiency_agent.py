...
from .tools.drugbank import get_SMILES, retrieval_drugbank
from .tools.hetionet import retrieval_hetionet


class EfficiencyAgent(LLMAgent):
    def __init__(self, depth=1):
        self.name = "efficiency_agent"
        self.role = """ 
                    As an efficiency expert, you have the capability to assess a drug's efficiency against diseases by examining its effectiveness on the disease. 
                    """
