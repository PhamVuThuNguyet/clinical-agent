...
class EnrollmentAgent(LLMAgent):
    ...
    def get_enrollment_difficulty(
        self, eligibility_criteria, drug_name="", disease_name=""
    ):
        result = get_enrollment_difficulty(
            eligibility_criteria, drug_name, disease_name
        )
